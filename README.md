...
Строки в таблице кликабельны и весlen на страницу с отображением полных данных,
...
<li>Можно кликнуть и перейти на страницу с отображением полных данных о:</li>
<li>"Модель техники", "Модель двигателя", "Модель трансмиссии", "Модель ведущего моста"</li>
<li>"Модель управляемого моста", "Клиент", "Сервисная компания", "Вид ТО"</li>
<li>"Организация, проводившая ТО", "Машина", "Узел отказа", "Способ восстановления"</li>
</ul>
